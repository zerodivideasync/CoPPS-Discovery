...
$id_pathology = filter_input(INPUT_POST, 'id_pathology', FILTER_VALIDATE_INT);
if(!is_numeric($id_pathology)) { //Id of a pathology. If set as integer, we show only a subset of diagnoses.
    $id_pathology = false;
}
...
if (!$ne_lat || !$ne_lng || !$sw_lat || !$sw_lng) {
    ...
    $global_shapes = array();
    $geographies = DiagnosisDAOPsql::getByAreaPolygon($location, $id_loaded, false, false, $id_pathology); //Search all shapes in $location excluding $id_loded
